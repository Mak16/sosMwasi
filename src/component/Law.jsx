...
function Type({title,children}) {
    return(
        <div className='xl:w-[30%] mx-auto my-4 p-8 bg-white md:w-[45%] shadow-2xl sm:w-[27%] w-full space-y-5'>
            <div className='bg-blue w-10 h-10 flex justify-center items-center'>
                <Icon icon="octicon:law-16" className='w-8 h-8 text-white'/>
            </div>
            <div className='space-y-3'>
                <h2 className='text-[#383838] font-bold text-xl font-poppins'>{title}</h2>
                <p className='text-[#383838] font-poppins'>{children}</p>
                <Link className='text-blue font-poppins'>Voir plus...</Link>
            </div>
        </div>
    )
}
...
export default function Law() {
  return (
    <div className='mt-24 lg:mt-48'>
        <div className='lg:w-[80%] w-full mx-auto lg:pl-5 pl-0'>
        <h2 className='lg:text-start text-center text-blue font-bold text-2xl lg:text-3xl font-poppins'>Que dit la loi?</h2> 
        </div>
        <div className='flex flex-row w-[80%] mx-auto flex-wrap my-16'>
        ...
        <p className='text-[#095789] text-center text-lg lg:text-xl px-2 lg:px-0 font-poppins'>Agissez dès aujourd’hui pour contribuer à mettre fin à la violence à l’égard des femmes.</p>
        <Link to='' className='text-[#095789] flex font-bold font-poppins flex-row justify-center items-center text-center'>
