...
export default function Type() {
  return (
    <div className='w-[90%] mx-auto  pb-10 px-10'>
        <h2 className='lg:text-start text-center text-blue font-bold text-3xl pb-5'>Assistance</h2>
       <div className='flex lg:flex-row flex-col justify-center mx-auto items-center w-full gap-4'>
        <div className='lg:w-1/4 w-full'>
         ...
         <h2 className='text-[#E90000] font-bold text-2xl'>250</h2>
          ...
          <button className="bg-blue text-white flex justify-center items-center py-1 px-2">
          Trouver maintenant
          </button>
         </div>
        </div>
